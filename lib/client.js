window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const en = {
      ...
      "card.description":"Immediate fallback from first sentence instantly, then async LLM title after first round, think-tag filtered, once per session, respects user rename.",
